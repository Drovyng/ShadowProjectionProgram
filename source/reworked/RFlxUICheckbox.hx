 ...
 * @author Lars Doucet
 */
class RFlxUICheckBox extends FlxUIGroup implements ILabeled implements IFlxUIClickable implements IHasParams implements ICursorPointable
{
	...
	public function new(X:Float = 0, Y:Float = 0, ?Box:Dynamic, ?Check:Dynamic, ?Label:String, ?LabelW:Int = 100, ?Params:Array<Dynamic>, ?Callback:Void->Void)
	{
        ...
        box.setGraphicSize(20, 20);
        box.updateHitbox();
        box.setPosition(pos.x, pos.y);

		button = new FlxUIButton(0, 0, "", _clickCheck);
