 ...
 * @author Lars Doucet
 */
class RFlxUITabMenu extends FlxUIGroup implements IResizable implements IFlxUIClickable implements IEventGetter
{
	...
	/***PUBLIC***/
	public function new(?back_:FlxSprite, ?tabs_:Array<FlxUIButton>, ?tab_names_and_labels_:Array<{name:String, label:String}>, ?tab_offset:FlxPoint,
	...
	public function getTab(?name:String, ?index:Null<Int>):FlxUIButton
	{
		if (name != null)
		{
			for (tab in _tabs)
